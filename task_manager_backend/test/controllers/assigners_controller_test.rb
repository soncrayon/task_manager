...
class AssignersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assigner" do
    assert_difference('Assigner.count') do
      post assigners_url, params: { assigner: { task_id: @assigner.task_id, user_id: @assigner.user_id } }, as: :json
    end
  ...
  test "should update assigner" do
    patch assigner_url(@assigner), params: { assigner: { task_id: @assigner.task_id, user_id: @assigner.user_id } }, as: :json
    assert_response 200
  end
